...
def generar_grafico_dispersion(estadisticas):
    ...
    # Contar cuantas electrolineras hay en uso
    cantidad_electrolineras = 0
    for nombre in uso:
        cantidad_electrolineras = cantidad_electrolineras + 1
    
    if cantidad_electrolineras == 0:
        print("no hay uso de electrolineras para graficar.")
        return ""
